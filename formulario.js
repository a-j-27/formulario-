var openBtn = document.querySelector('.open__form');
var main = document.querySelector('.main')
var btns = document.querySelectorAll('.btn button')
var signInBtn = document.querySelector('.sign__in')
var signUpBtn = document.querySelector('.sign__up')
var signInForm = document.querySelector('.sign__in__form')
var signUpForm = document.querySelector('.sign__up__form')
...
passwordInput1.addEventListener('focus', () => {
  if (passwordInput1.ariaValueMax.trim() != '') {
